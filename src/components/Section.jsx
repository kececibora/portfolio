...
export function Section({ id, index, eyebrow, title, note, children, className = '' }) {
  ...
  return (
    <section
      ...
      className={`section-shell relative mx-auto max-w-shell px-5 py-24 sm:px-8 md:py-28 ${className}`}
    >
      ...
      <Reveal className="relative">
        ...
        <h2 id={`${id}-title`} className="mt-5 max-w-3xl font-display text-3xl font-bold leading-[1.08] tracking-tight text-text sm:text-4xl md:text-5xl">
          {title}
        </h2>
