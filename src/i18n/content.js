  ...
  tr: {
    ...
    projects: {
      ...
      groups: [
        {
          ...
          codes: ['platform/bks-panel', 'app/bks-flow', 'app/bks-smart', 'app/bks-messenger'],
      ...
      items: [
        ...
        {
          name: 'BKS Messenger',
          desc: 'Şirket çalışanları için birebir ve grup mesajlaşma, sesli/görüntülü arama ve yapay zekâ destekli proje takibi sunan kurumsal iletişim uygulaması. Google Play’de yayında.',
          tags: ['Flutter', 'Firebase', 'WebRTC', 'Gerçek Zamanlı'],
          features: [
            'Birebir ve grup sohbetleri — metin, fotoğraf, video ve dosya paylaşımı',
            'WebRTC ile sesli arama ve HD görüntülü görüşme',
            'Çoklu şirket hesabı ve hesap başına bildirim yönetimi',
            'Yapay zekâ destekli proje asistanı ile görev ve durum takibi',
          ],
          code: 'app/bks-messenger',
          image: '/projects/bks-messenger.webp',
          links: [{ kind: 'play', url: 'https://play.google.com/store/apps/details?id=com.bkscam.bkschat' }],
        },
        {
        ...
        {
          name: 'AI Model Eğitimi & Görsel Okuma',
          desc: 'Kento için kendi evrişimli sinir ağlarımı PyTorch ile eğittim: StoneNet ile fotoğraf ve videodaki Go taşlarını siyah, beyaz ve boş olarak sınıflandırdım; köşe tespiti ve ince ayar modelleri geliştirdim. Sentetik ve gerçek verilerle eğitim, veri artırma ve doğrulama süreçlerini kurup modelleri tamamen cihazda çalışacak şekilde Dart’a aktardım.',
          tags: ['PyTorch', 'CNN', 'Bilgisayarla Görü', 'Dart', 'Cihaz Üstü AI'],
          code: 'ai/stonenet',
          image: '/projects/stonenet.webp',
          figure: 'FIG. AI',
        },
        {
        ...
        },
        {
          ...
          tags: ['React', 'Vite', 'Vercel', 'Yerel SEO'],
          code: 'web/isi-pompasi',
          image: '/projects/isi-pompasi.webp',
          links: [{ kind: 'site', url: 'https://isipompasi.vercel.app/' }],
        },
        {
          ...
          tags: ['React', 'Vite', 'Vercel', 'WhatsApp Deep Link'],
          code: 'web/ilgin-sal',
          image: '/projects/ilgin-sal.webp',
          links: [{ kind: 'site', url: 'https://ilginsal.vercel.app/' }],
        },
        {
    ...
    education: {
      ...
      items: [
        ...
        { schoolId: 'anadolu', school: 'Anadolu Üniversitesi', program: 'Bilgisayar Programcılığı', period: '2026' },
      ],
    },
  ...
  en: {
    ...
    projects: {
      ...
      items: [
        ...
        {
          name: 'BKS Messenger',
          desc: 'An enterprise communication app for company staff: one-to-one and group messaging, voice and video calls, and AI-assisted project tracking. Published on Google Play.',
          tags: ['Flutter', 'Firebase', 'WebRTC', 'Realtime'],
          features: [
            'One-to-one and group chats with text, photo, video, and file sharing',
            'Voice calls and HD video calls over WebRTC',
            'Multiple company accounts with per-account notification control',
            'AI-assisted project assistant for task and status tracking',
          ],
          code: 'app/bks-messenger',
          image: '/projects/bks-messenger.webp',
          links: [{ kind: 'play', url: 'https://play.google.com/store/apps/details?id=com.bkscam.bkschat' }],
        ...
        {
          name: 'AI Model Training & Computer Vision',
          desc: 'For Kento, I trained my own convolutional neural networks in PyTorch: StoneNet classifies Go intersections in photos and video as black, white, or empty, alongside models for corner detection and refinement. I built training, augmentation, and validation workflows with synthetic and real data, then ported the models to Dart for fully on-device inference.',
          tags: ['PyTorch', 'CNN', 'Computer Vision', 'Dart', 'On-device AI'],
          code: 'ai/stonenet',
          image: '/projects/stonenet.webp',
          figure: 'FIG. AI',
        },
        ...
        },
        {
          ...
          tags: ['React', 'Vite', 'Vercel', 'Local SEO'],
          code: 'web/isi-pompasi',
          image: '/projects/isi-pompasi.webp',
          links: [{ kind: 'site', url: 'https://isipompasi.vercel.app/' }],
        },
    ...
    education: {
      ...
      items: [
        ...
        { schoolId: 'anadolu', school: 'Anadolu University', program: 'Computer Programming', period: '2026' },
      ],
    },
