      ...
      items: [
        {
          ...
          bullets: [
            ...
            'Teklif ve sipariş çıktıları için PDF/Excel üretimi; grafik ve dashboard tabanlı raporlama geliştirdik.',
      ...
      items: [
        {
          ...
          bullets: [
            ...
            'Built PDF/Excel export for quotes and orders, plus chart- and dashboard-based reporting.',
